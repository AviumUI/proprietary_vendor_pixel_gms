...
- This is as simple as: `$(call inherit-product-if-exists, vendor/pixel/gms/products/gms.mk)`
...
- Install `sponge`
  - `sudo apt install moreutils`, `sudo pacman -S moreutils`, etc. depending on your distribution.
- Install `xml_pp`
  - `sudo apt install xml-twig-tools`, `sudo pacman -S perl-XML-Twig`, etc. depending on your distribution.
